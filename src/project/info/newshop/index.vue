  ...
  .section__content
    ...
    .section.top
     ...
     .section.top__info-block
      ...
      .section.top__info-block__paragraph Теперь, стоит клиенту написать #[br.break_3] @wantit #[br.break_4] в комментариях под твоим #[br.break_5] постом, в приложении Trendever #[br.break_6] появится #[br.break_7] шопинг-чат с ним
      ...
      .section.top__info-block__title.cost Сколько стоят услуги Trendever?
      .section.top__info-block__desc Плати только за результат
      .section.top__info-block__prices-block
       .section.top__info-block__prices-block__box
        .section.top__info-block__prices-block__box__price 0
           i.ic-currency-rub
          .top__info-block__prices-block__box__description витрина #[br] на Trendever
       .section.top__info-block__prices-block__box
        .section.top__info-block__prices-block__box__price 0
           i.ic-currency-rub
          .top__info-block__prices-block__box__description шопинг-чаты #[br] с клиентами
       .section.top__info-block__prices-block__box
        .section.top__info-block__prices-block__box__price 0
           i.ic-currency-rub
       ...
       .section.top__info-block__prices-block__box
        .section.top__info-block__prices-block__box__price 3.5
         i.percent %
      ...
      .section.top__info-block__list-description.add-goods Добавь текст в профиль #[br] своего Instagram: #[br]
         span.wantit Напиши @wantit и товар #[br] попадет в шопинг - #[br] приложение по ссылке ниже
      ...
      .section.top__info-block__list-description.tell-clients При размещении #[br] новых товаров в Instagram, #[br] напиши в начале описания:
       span.wantit Покупай по комментарию #[br] @wantit
       span Кстати, товар с @wantit #[br] в описании попадет в твой #[br] Trendever
